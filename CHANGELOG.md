...
- 新增 Pi Agent 设计借鉴专题，在第 5、10、11、12、19、23、24、26、36、40、42 章补充最小 Prompt/工具面、会话树、工具结果双视图、安全架构对照、上下文压缩、自我扩展、工具交付 token 经济学、子代理边界、模式选型、供应商抽象和提示词版本治理。
- 新增 REF-148 至 REF-152 的来源登记与逐章映射；11 个目标章节的正文、front matter、候选参考和事实核验工件保持一致，并明确这些内容不表示本仓库运行、移植或基准测试过 pi。

### Changed

- 第 10 章新增“会话即树”，第 12 章新增“三种安全架构对照”；第 36 章借鉴矩阵继续区分可直接借鉴、必须补充护栏和不应照搬的结论。
- 将项目版本更新为 `0.2.0`，继续通过 GitHub Pages 提供在线阅读，并由 Release 工作流从版本标签生成和归档 PDF/EPUB。
