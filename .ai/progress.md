...
- 2026-07-26：`v0.2.0` 已从提交 `8b43aa6` 发布为 Latest Release。Pages、发行归档、Markdown lint 与 link check 工作流均成功；线上首页主入口和第 10 章“会话即树”锚点已完成浏览器点击复验。Release PDF 为 A4 521 页且字体全部嵌入，抽检第 1、95、96、120、521 页通过；EPUB 解压与 EPUBCheck 5.3.0 通过，PDF/EPUB 的 GitHub digest 与独立下载文件 SHA-256 一致。
- 2026-07-26：完成 Pi Agent 借鉴点专项增补及 Claude Code 二次复查。REF-148 至 REF-152 已按实际使用映射到第 5、10、11、12、19、23、24、26、36、40、42 章；第 10 章补“会话即树”，第 12 章补“三种安全架构对照”，11 章共 27 组 REF 的正文、front matter、候选参考、事实核验与全局分配区一致。Claude Code 首轮提出的 4 项 must_fix、6 项 should_fix 与 3 项 suggestion 均已修正，二次只读复查结论为 `PASS`。逐章 Markdown 校验、`npm run validate`、站点构建与 308 页链接检查均通过；Playwright 对第 10、11、12、23、24、26、36 章完成新增小节锚点点击复验，最终控制台 0 错误、0 警告。本地 PDF/EPUB 构建、PDF 字体与抽页目检、EPUBCheck 均通过，增补随后随 `v0.2.0` 发布；该增补不表示本仓库运行、移植或基准测试过 pi。
