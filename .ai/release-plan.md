...
- VitePress：`main` 更新后由 `.github/workflows/deploy-pages.yml` 构建、检查并部署至 `https://sandu1213.github.io/Harness-Engineering-Guide/`。
...
采用语义化发布意图：`0.x` 为内容和结构快速演进，`1.0` 表示首版书稿完成。`v0.1.0` 已作为首个公开中文版本发布；后续版本继续由维护者确认标签、内容边界和发布授权。
