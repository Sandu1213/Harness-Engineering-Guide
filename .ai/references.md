...
| REF-148 | [pi 仓库 README（badlogic/pi-mono，现迁移至 earendil-works/pi）](https://github.com/earendil-works/pi) | 第 5、12、19、23、26、36、40、42 章开源项目资料，用于 pi 的 monorepo 包结构、四个默认工具与默认关闭的只读工具组、无内置权限系统与容器/micro-VM 外置隔离模式、MIT 协议与仓库迁移事实；不外推为其他 harness 的行为、任何安全保证或长期不变的项目状态。 | 2026-07-26 已读取仓库 README；项目结构与特性随版本变化，改写时重查 |
| REF-149 | [Zechner, Mario. What I learned building an opinionated and minimal coding agent (2025-11-30)](https://mariozechner.at/posts/2025-11-30-pi-coding-agent/) | 第 5、10、11、12、24、26、36、40、42 章作者博文，用于 pi 系统提示词加工具定义低于 1000 token 的自述、四工具充分性论证、刻意省略清单（MCP、内置 todo、计划模式、子代理、后台 bash、权限系统）及作者理由、provider 四种线协议与 Completions 兼容层差异清单、上下文可检查性与 harness 稳定性主张；均为作者个人工程立场与自述数据，不作为行业结论、跨模型保证或本书验证过的性能事实。 | 2026-07-26 已通读原文；作者立场与产品状态随版本变化，改写时重查 |
| REF-150 | [Zechner, Mario. What if you don't need MCP at all? (2025-11-02)](https://mariozechner.at/posts/2025-11-02-what-if-you-dont-need-mcp/) | 第 24、36 章作者博文，用于其当日实测的 MCP 工具定义 token 占用（Playwright MCP 21 工具约 13.7k token、Chrome DevTools MCP 26 工具约 18k token）与等价 CLI README 约 225 token 的对比，以及 CLI 加文档的渐进披露替代方案论证；数字为作者特定环境实测，不外推为所有 MCP Server、其他版本或长期数值。 | 2026-07-26 已通读原文；实测数字保持作者归属，改写时重查 |
| REF-151 | [Ronacher, Armin. Pi: The Minimal Agent Within OpenClaw (2026-01-31)](https://lucumr.pocoo.org/2026/1/31/pi/) | 第 10、23、24、36 章作者博文，用于"最小核心加可持久状态扩展系统"的定性、代理为自己编写扩展的工作流描述、MCP 工具定义随会话固化与 prompt cache 冲突的结构性批评、会话树支线工作流；均为作者个人观点，不作为产品保证或行业标准。 | 2026-07-26 已通读原文；个人观点随生态变化，改写时重查 |
| REF-152 | [pi 官方文档：extensions、sessions、compaction（packages/coding-agent/docs）](https://github.com/earendil-works/pi/tree/main/packages/coding-agent/docs) | 第 10、19、23、36 章项目官方文档，用于扩展 API 的事件订阅与工具/命令注册面、会话 JSONL 树结构（id/parentId、树内导航、fork/clone、分支摘要）、compaction 触发条件、turn 边界切割、split-turn 双摘要、结构化摘要模板与扩展接管钩子；以访问日 main 分支为准，实现细节随版本变化，不外推为其他 harness 的会话或压缩行为。 | 2026-07-26 已读取 main 分支文档；实现细节改写时重查 |
...
| REF-148 | 05 | pi 访问日 README 中四个默认工具与默认关闭的只读工具组。 | 2026-07-26 | 已重读项目 README；不外推为其他 Harness 的默认值或安全保证。 |
| REF-149 | 05 | 作者自述的系统提示词加工具定义预算，以及四工具充分性的工程理由。 | 2026-07-26 | 已通读作者原文；保留作者主语，不使用排名或分数。 |
...
| REF-149 | 10 | pi 作者关于可检查上下文与稳定 Harness 的工程立场。 | 2026-07-26 | 已通读作者原文；不写成通用会话保证。 |
| REF-151 | 10 | 支线修复后回到主线并注入分支摘要的作者观察。 | 2026-07-26 | 已通读原文；不外推外部效果回滚或产品保证。 |
| REF-152 | 10 | pi 追加式 JSONL 会话树、树内导航、分支摘要与扩展状态条目。 | 2026-07-26 | 已重读项目文档；只描述访问日 pi 机制。 |
...
| REF-149 | 11 | pi 作者关于 Tool 输出与 details 分离、渐进 JSON 输出及四工具面的工程经验。 | 2026-07-26 | 已通读作者原文；不外推为统一协议或跨模型保证。 |
...
| REF-148 | 12 | pi 无内置权限系统、默认完整执行能力及容器/micro-VM 外置隔离模式。 | 2026-07-26 | 已重读项目 README；不证明隔离天然安全。 |
| REF-149 | 12 | pi 作者对应用层权限提示可能制造虚假安全感的个人工程立场。 | 2026-07-26 | 已通读作者原文；不写成取消批准的行业结论。 |
...
| REF-148 | 19 | pi 项目背景、MIT 协议与官方 compaction 文档入口。 | 2026-07-26 | 已重读 README；不据此推断压缩机制。 |
| REF-152 | 19 | pi 的 compaction 触发、turn 边界、双摘要、结构化模板和扩展接管钩子。 | 2026-07-26 | 已重读项目文档；不外推为其他 Harness 行为或摘要无损保证。 |
...
| REF-148 | 23 | pi 的扩展系统与最小核心项目背景。 | 2026-07-26 | 已重读 README；不证明扩展安全或长期接口稳定。 |
| REF-151 | 23 | “最小核心加可持久状态扩展系统”及代理自写扩展的作者观察。 | 2026-07-26 | 已通读原文；不外推为产品保证。 |
| REF-152 | 23 | pi 扩展的事件订阅、工具/命令注册与会话状态持久化接口。 | 2026-07-26 | 已重读项目文档；只描述访问日公开机制。 |
...
| REF-149 | 24 | pi 作者不内置 MCP、需要时包装为 CLI 的个人设计选择。 | 2026-07-26 | 已通读作者原文；不写成所有 MCP 集成的结论。 |
| REF-150 | 24 | 作者特定环境中的 MCP 工具定义 token 测量与 CLI 文档渐进披露对照。 | 2026-07-26 | 已通读作者原文；数字不外推其他 Server、版本或模型。 |
| REF-151 | 24 | MCP 工具定义随会话固化与 prompt cache 热更新冲突的作者观点。 | 2026-07-26 | 已通读原文；不写成协议或所有 Client 的保证。 |
...
| REF-148 | 26 | pi 的开源极简 Agent 项目背景与访问日文档入口。 | 2026-07-26 | 已重读 README；不据此推断子代理立场。 |
| REF-149 | 26 | pi 作者对内置子代理、上下文传递、并行 spawn 与可观察逃生路径的个人立场。 | 2026-07-26 | 已通读作者原文；不外推为多 Agent 的行业结论。 |
...
| REF-148 | 36 | pi 的最小 Agent 核心、工具面、外置隔离与扩展入口。 | 2026-07-26 | 已重读 README；仅用于模式对照。 |
| REF-149 | 36 | pi 作者对最小提示词、工具、权限、MCP 与子代理的取舍立场。 | 2026-07-26 | 已通读作者原文；不写成模式优劣的通用结论。 |
| REF-150 | 36 | MCP 与 CLI 文档渐进披露的作者实测和论证。 | 2026-07-26 | 特定环境数字不外推。 |
| REF-151 | 36 | 最小核心、持久扩展、会话树与缓存冲突的作者观察。 | 2026-07-26 | 已通读原文；不作为产品保证。 |
| REF-152 | 36 | pi 扩展、会话树和 compaction 的公开实现文档。 | 2026-07-26 | 已重读项目文档；只描述访问日机制。 |
...
| REF-148 | 40 | pi 模型注册表的数据来源与价格、能力元数据入口。 | 2026-07-26 | 已重读 README；不摘录数值或保证数据新鲜。 |
| REF-149 | 40 | provider 四种线协议、兼容差异、跨 provider 上下文和 best-effort 计量经验。 | 2026-07-26 | 已通读作者原文；不外推为供应商当前行为。 |
...
| REF-148 | 42 | pi 的开源项目背景、稳定 Prompt 与可替换系统提示词入口。 | 2026-07-26 | 已重读 README；不保证行为可复现。 |
| REF-149 | 42 | 系统提示词变化观察、cchistory、稳定 Prompt 目标与可复现评测方法。 | 2026-07-26 | 已通读作者原文；不使用排名或分数。 |
