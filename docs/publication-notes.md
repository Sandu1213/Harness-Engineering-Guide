...
每次 GitHub Release 发布后，发行工作流会从该 Release 的标签提交重新生成 `harness-engineering-guide.pdf` 与 `harness-engineering-guide.epub`，完成基础文件校验后附加到对应 Release。当前中文版为 [`v0.2.0`](https://github.com/Sandu1213/Harness-Engineering-Guide/releases/tag/v0.2.0)，读者可下载 PDF 与 EPUB；源码与出版物采用 MIT 许可证。
